      ...
      <main className="min-h-screen px-6 py-16">
        ...
        <div className="mx-auto mt-14 grid max-w-3xl gap-6 md:grid-cols-2">
          ...
          <div className="card relative overflow-hidden border-accent/40 p-8">
            ...
            <p className="mt-1 text-sm text-muted">{PRO_DURATION_DAYS} дней доступа после оплаты</p>
            <ul className="mt-6 flex flex-col gap-2.5 text-sm text-muted">
            ...
            {isPro ? (
              ...
              <Link href="/login" className="btn-primary mt-8 block rounded-full py-3 text-center font-semibold">
                Войти для оплаты
              </Link>
            ) : waLink ? (
              <div className="mt-8">
              ...
              <div className="mt-8">
                <div className="btn-primary block cursor-not-allowed rounded-full py-3 text-center font-semibold opacity-80">
                  Оплата настраивается
                </div>
                <p className="mt-3 text-center text-xs text-muted">Скоро откроем приём платежей.</p>
              </div>
            )}
          </div>
        </div>
